	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#0S7H_kkVP5U') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/keywords-element/') ),
				'copy'    => $uid,
				'general' => true,
			)),
