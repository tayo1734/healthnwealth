	...
	function options()
	{
		...
		$options = array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#PMwI-Jsy1Ck&list') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/action-box/') ),
				'copy'    => false,
				'general' => true,
			)),
		);
