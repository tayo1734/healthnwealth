...
$admin_options[] = array(
	...
	'description' => sprintf(
		__( 'Please provide the token you got from the <a href="%s" target="_blank" title="Link will open in a new tab/window">Typekit website</a>. After saving the token, you will need to refresh the page to see your kits.', 'zn_framework')
