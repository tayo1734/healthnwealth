...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    var self = this;
    window.jQuery('<div id="vce-lightbox-overlay" class="vce-lightbox-overlay"></div><div id="vce-lightbox" class="vce-lightbox"><div class="vce-lb-outer-container"><div class="vce-lb-container"><img class="vce-lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="vce-lb-nav"><a class="vce-lb-prev" href="" ></a><a class="vce-lb-next" href="" ></a></div><div class="vce-lb-loader"><a class="vce-lb-cancel"></a></div></div></div><div class="vce-lb-data-container"><div class="vce-lb-data"><div class="vce-lb-details"><span class="vce-lb-caption"></span><span class="vce-lb-number"></span></div><div class="lb-closeContainer"><a class="vce-lb-close"></a></div></div></div></div>').appendTo(window.jQuery('body'));

    // Cache jQuery objects
    this.$lightbox       = window.jQuery('#vce-lightbox');
    this.$overlay        = window.jQuery('#vce-lightbox-overlay');
    this.$outerContainer = this.$lightbox.find('.vce-lb-outer-container');
  ...
  Lightbox.prototype.changeImage = function(imageNumber) {
    ...
    this.$lightbox.find('.vce-lb-image, .vce-lb-nav, .vce-lb-prev, .vce-lb-next, .vce-lb-data-container, .vce-lb-numbers, .vce-lb-caption').hide();
  ...
  Lightbox.prototype.sizeContainer = function(imageWidth, imageHeight) {
    ...
    function postResize() {
      self.$lightbox.find('.vce-lb-data-container').width(newWidth);
  ...
  Lightbox.prototype.updateDetails = function() {
    ...
    this.$lightbox.find('.vce-lb-data-container').fadeIn(this.options.resizeDuration, function() {
